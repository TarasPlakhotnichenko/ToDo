...
public class ViewFragment0 extends Fragment {
    ...
    public View onCreateView (@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //----------JUST FOR FUN-------------------------vvv
        String[]  wordList1 = {"круглосуточный", "трех-звенный", "взаимный", "на основе веб-технологий", "проникающий", "умный", "динамичный", "шесть сигм", "метод критического пути", "как всегда","посевная"};
        String[]  wordList2 = {"чистый продукт","и","как бы", "трудный", "уполномоченный","нестандартный ум","общий","совместный","сетевой","фирменный","ориентированный","нацеленный на","крутой", "получилось"};
        String[]  wordList3 = {"процесс","образец", "выход из положения", "талант","структура","обзор","пункт разгрузки","пятилетка","весна","мир","труд","май"};
